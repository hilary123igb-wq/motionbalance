...
export declare const FN_LIGHT_DARK = "light-dark(";
...
export declare const SYN_FN_LIGHT_DARK = "^light-dark\\(";
...
export declare const DEC = 10;
export declare const DEG = 360;
export declare const DEG_HALF = 180;
export declare const DOZ = 12;
export declare const DUO = 2;
export declare const HALF = 0.5;
export declare const HEX = 16;
export declare const LAB_A = 500;
export declare const LAB_B = 200;
export declare const LAB_EPSILON: number;
export declare const LAB_KAPPA: number;
export declare const LAB_L = 116;
export declare const LINEAR_COEF = 12.92;
export declare const LINEAR_OFFSET = 0.055;
export declare const MAX_LENGTH = 1024;
export declare const MAX_PCT = 100;
export declare const MAX_RGB = 255;
export declare const OCT = 8;
export declare const POW_CUBE = 3;
export declare const POW_LINEAR = 2.4;
export declare const POW_SQR = 2;
export declare const PPTH = 0.001;
export declare const QUAD = 4;
export declare const SEXA = 60;
export declare const TRIA = 3;
